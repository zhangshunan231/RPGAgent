...
def create_scene_agent():
    ...
    agent = autogen.AssistantAgent(
        ...
        system_message=(
            ...
            "   简单的映射（基于story中的关键词或主题）：\n"
            "   - 自然/森林/草原主题（包含'forest', 'grassland', 'nature'等词）：noiseScale=30, landThreshold=0.2, mountainThreshold=0.7\n"
            "   - 都市/城堡/村庄主题（包含'village', 'castle', 'urban'等词）：noiseScale=20, landThreshold=0.15, mountainThreshold=0.8\n"
            "   - 洞穴/地下/冒险主题（包含'cave', 'dungeon', 'adventure'等词）：noiseScale=15, landThreshold=0.1, mountainThreshold=0.6\n"
            "   - 如果混合或不确定，使用默认值：noiseScale=25, landThreshold=0.18, mountainThreshold=0.75\n"
